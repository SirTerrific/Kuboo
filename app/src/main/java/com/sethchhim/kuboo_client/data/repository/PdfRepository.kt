...
import com.sethchhim.kuboo_client.data.task.pdf.Task_GetPdfImage
...
class PdfRepository {
    ...
    internal fun getPdfImage(glidePdf: GlidePdf) = Task_GetPdfImage(document, glidePdf).liveData

    internal fun getPdfImageSingleInstance(glidePdf: GlidePdf) = Task_GetPdfImage(Document.openDocument(glidePdf.book.filePath), glidePdf).liveData
